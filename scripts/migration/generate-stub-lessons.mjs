...
//  ARCHIVED one-shot from the flat-layout era: it writes stubs as
//  src/content/lessons/<slug>.mdx, which predates the Module_xx/
//  subtopic tree (2026-06 restructure). Rework LESSONS_DIR before
