...
//  to docs/reports/migration-inventory.json.
//
//  Usage:
//    node scripts/migration/inventory-v1.mjs        # auto-detect v1 as sibling
//    V1_ROOT=/path/to/numpy-to-genAI node scripts/migration/inventory-v1.mjs
//
...
const SUBTOPICS_PATH = join(V2_ROOT, 'src', 'data', 'curriculum', 'subtopics.ts');
const MODULES_PATH = join(V2_ROOT, 'src', 'data', 'curriculum', 'modules.ts');
const OUTPUT_PATH = join(V2_ROOT, 'docs', 'reports', 'migration-inventory.json');
