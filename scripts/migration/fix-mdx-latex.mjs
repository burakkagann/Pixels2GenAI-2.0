// ARCHIVED one-off LaTeX brace escaper from the flat-layout era — the FILES
// list below uses pre-restructure paths. Point it at the new
// src/content/lessons/Module_xx/... paths (or take argv) before reusing.
//
