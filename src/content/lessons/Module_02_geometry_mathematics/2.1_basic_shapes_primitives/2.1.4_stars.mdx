...
Click **Run** on the code above to generate the star field in your browser, then compare your result with the expected output (your stars will land in different places, because the positions are random).
