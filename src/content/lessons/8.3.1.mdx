...
<Figure
  src="/lessons/8.3.1/sw_animation.gif"
...
<Download href="/lessons/8.3.1/starwars.py" label="starwars.py — perspective crawl" />
<Download href="/lessons/8.3.1/message.txt" label="message.txt — Zen of Python text" />
...
<Download href="/lessons/8.3.1/starwars.py" label="starwars.py — perspective crawl renderer" />
<Download href="/lessons/8.3.1/message.txt" label="message.txt — Zen of Python text" />
