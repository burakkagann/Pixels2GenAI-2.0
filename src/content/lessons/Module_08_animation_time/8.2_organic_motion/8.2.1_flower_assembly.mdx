...
Click **Run** on the code above to create the flower animation in your browser, then compare your result with the expected output.

<Dropdown summary="Expected output">

<Figure
  src="/lesson-media/Module_08_animation_time/8.2_organic_motion/8.2.1_flower_assembly/flower_assembly.gif"
...
<Download href="/lesson-media/Module_08_animation_time/8.2_organic_motion/8.2.1_flower_assembly/flower_assembly.py" label="flower_assembly.py — full reference implementation" />
...
<Download href="/lesson-media/Module_08_animation_time/8.2_organic_motion/8.2.1_flower_assembly/flower_assembly.py" label="flower_assembly.py — full reference" />
<Download href="/lesson-media/Module_08_animation_time/8.2_organic_motion/8.2.1_flower_assembly/flower.png" label="flower.png — synthetic input" />
