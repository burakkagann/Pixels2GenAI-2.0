...
<Figure
  src="/lessons/11.1.1/pipeline_demo.png"
...
<Figure
  src="/lessons/11.1.1/webcam_pipeline.gif"
...
<Download href="/lessons/11.1.1/webcam_capture.py" label="webcam_capture.py — minimal OpenCV capture" />
<Download href="/lessons/11.1.1/synthetic_webcam.py" label="synthetic_webcam.py — no-camera demo" />
...
<Download href="/lessons/11.1.1/webcam_starter.py" label="webcam_starter.py — frame differencing skeleton" />
...
<Download href="/lessons/11.1.1/webcam_capture.py" label="webcam_capture.py — minimal capture loop" />
<Download href="/lessons/11.1.1/webcam_effects.py" label="webcam_effects.py — real-time filters" />
<Download href="/lessons/11.1.1/background_subtraction.py" label="background_subtraction.py — motion detection" />
<Download href="/lessons/11.1.1/synthetic_webcam.py" label="synthetic_webcam.py — no-camera demo" />
