...
<Figure
  src="/lessons/2.1.4/simple_star.png"
...
<Figure
  src="/lessons/2.1.4/distribution_comparison.png"
...
<Figure
  src="/lessons/2.1.4/multi_cluster.png"
...
<Download href="/lessons/2.1.4/simple_star.py" label="simple_star.py — uniform scatter" />
<Download href="/lessons/2.1.4/gaussian_cluster.py" label="gaussian_cluster.py — single cluster" />
<Download href="/lessons/2.1.4/multi_cluster_solution.py" label="multi_cluster_solution.py — galaxy reference" />
