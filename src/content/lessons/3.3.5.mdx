...
<Figure
  src="/lessons/3.3.5/simple_delaunay.png"
...
<Figure
  src="/lessons/3.3.5/delaunay_concept_diagram.png"
...
<Figure
  src="/lessons/3.3.5/lowpoly_art_single.png"
...
<Download href="/lessons/3.3.5/simple_delaunay.py" label="simple_delaunay.py — wireframe quick start" />
<Download href="/lessons/3.3.5/colored_triangulation.py" label="colored_triangulation.py — randomly coloured triangles" />
<Download href="/lessons/3.3.5/lowpoly_art_starter.py" label="lowpoly_art_starter.py — Exercise 3 starter" />
<Download href="/lessons/3.3.5/lowpoly_art_solution.py" label="lowpoly_art_solution.py — Exercise 3 reference" />
