...
<Figure
  src="/lessons/3.1.4/simple_kaleidoscope.png"
...
<Figure
  src="/lessons/3.1.4/wedge_reflection.png"
...
<Figure
  src="/lessons/3.1.4/kaleidoscope_variations.png"
...
<Figure
  src="/lessons/3.1.4/mandala_pattern.png"
...
<Download href="/lessons/3.1.4/simple_kaleidoscope.py" label="simple_kaleidoscope.py — 6-fold quick start" />
<Download href="/lessons/3.1.4/kaleidoscope_variations.py" label="kaleidoscope_variations.py — fold-count comparison" />
<Download href="/lessons/3.1.4/mandala_starter.py" label="mandala_starter.py — Exercise 3 starter" />
<Download href="/lessons/3.1.4/mandala_solution.py" label="mandala_solution.py — Exercise 3 reference" />
