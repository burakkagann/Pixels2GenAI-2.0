...
<Figure
  src="/lessons/1.3.2/repeat/repeat.png"
...
<Figure
  src="/lessons/1.3.2/repeat/position_calculation_diagram.png"
...
<Figure
  src="/lessons/1.3.2/repeat/nested_loop_execution.png"
...
<Download href="/lessons/1.3.2/repeat/repeat.py" label="repeat.py -- gradient tiling script" />
...
<Figure
  src="/lessons/1.3.2/repeat/tiling_variations.png"
...
<Download href="/lessons/1.3.2/repeat/checkerboard_starter.py" label="checkerboard_starter.py -- starter template" />
...
<Figure
  src="/lessons/1.3.2/repeat/checkerboard.png"
...
<Download href="/lessons/1.3.2/repeat/repeat.py" label="repeat.py -- gradient tiling script" />
<Download href="/lessons/1.3.2/repeat/checkerboard_starter.py" label="checkerboard_starter.py -- Exercise 3 starter" />
<Download href="/lessons/1.3.2/repeat/checkerboard_solution.py" label="checkerboard_solution.py -- Exercise 3 solution" />
<Download href="/lessons/1.3.2/repeat/random_colors_challenge.py" label="random_colors_challenge.py -- bonus challenge" />
