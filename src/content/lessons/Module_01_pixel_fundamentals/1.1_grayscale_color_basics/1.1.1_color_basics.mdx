...
<Figure
  src="/lesson-media/Module_01_pixel_fundamentals/1.1_grayscale_color_basics/1.1.1_color_basics/rgb_additive_mixing_local.png"
...
<Download href="/lesson-media/Module_01_pixel_fundamentals/1.1_grayscale_color_basics/1.1.1_color_basics/rgb.py" label="rgb.py — combined script" />
<Download href="/lesson-media/Module_01_pixel_fundamentals/1.1_grayscale_color_basics/1.1.1_color_basics/rgb_additive_mixing_diagram.py" label="rgb_additive_mixing_diagram.py — diagram generator" />
