...
Click **Run** on the code above to generate the random tile grid in your browser, then compare your result with the expected output.

<Dropdown summary="Expected output">

<Figure
  src="/lesson-media/Module_01_pixel_fundamentals/1.2_pixel_manipulation_patterns/1.2.1_random_patterns/random_tiles_basic.png"
...
<Figure
  src="/lesson-media/Module_01_pixel_fundamentals/1.2_pixel_manipulation_patterns/1.2.1_random_patterns/random_tiles.png"
...
<Figure
  src="/lesson-media/Module_01_pixel_fundamentals/1.2_pixel_manipulation_patterns/1.2.1_random_patterns/random_tiles_grayscale.png"
...
<Figure
  src="/lesson-media/Module_01_pixel_fundamentals/1.2_pixel_manipulation_patterns/1.2.1_random_patterns/richter_style_grid.png"
...
<Download href="/lesson-media/Module_01_pixel_fundamentals/1.2_pixel_manipulation_patterns/1.2.1_random_patterns/random_tiles.py" label="random_tiles.py — combined script" />
