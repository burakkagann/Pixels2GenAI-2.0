...
<Figure
  src="/lessons/2.2.1/simple_gradient.png"
...
<Figure
  src="/lessons/2.2.1/linspace_diagram.png"
...
<Figure
  src="/lessons/2.2.1/diagonal_gradient.png"
...
<Download href="/lessons/2.2.1/simple_gradient.py" label="simple_gradient.py — quick start" />
<Download href="/lessons/2.2.1/gradient_variations.py" label="gradient_variations.py — direction panel" />
<Download href="/lessons/2.2.1/diagonal_gradient_solution.py" label="diagonal_gradient_solution.py — Exercise 3 reference" />
